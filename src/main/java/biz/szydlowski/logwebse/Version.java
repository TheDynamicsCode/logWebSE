...
public class Version  {
   ...
   static final Logger logger =  LogManager.getLogger(Version.class);
    ...
    /**Nazwa programu*/
    private static  String name = "LogWeb Search Engine";
  
    /**Nazwa programu*/
    private static  String fullname = "LogWeb Search Engine";
    ...
    /**Minor version*/
    private static int minor_version = 8;
    /**realse*/
    private static int realase = 0;
    /**build*/
    private static int build = 0;
     /**kompilacja*/
    private static  String update = "2021-08-24";
